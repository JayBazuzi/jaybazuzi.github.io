...
If you diligently write tests for all behaviors you intend to add to the system, you can apply `X -` but there may be behaviors that you don't know about but which your users have come to depend on - these would be "unknown risks".
