...
What is the danger? For me, the answer comes from this quote from a guest on Greater than Code:
...
If you've split your monolith service into multiple smaller services, how many of these are true for you?
...
- One service writes data to a repository; another service reads it from that repository.
